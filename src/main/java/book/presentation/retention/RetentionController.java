...
import static book.domain.model.item.ItemStatus.未登録;
import static book.domain.model.item.ItemStatus.貸出可能;
import static book.domain.model.reservation.retention.BookMatching.不一致;
