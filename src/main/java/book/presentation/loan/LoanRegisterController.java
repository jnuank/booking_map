package book.presentation.loan;

import book.application.coordinator.loan.LoanCoordinator;
import book.domain.model.loan.loan.LoanRequest;
import book.domain.model.loan.rule.LoanStatus;
import book.domain.model.loan.rule.Loanability;
...
import static book.domain.model.loan.rule.Loanability.貸出不可;
